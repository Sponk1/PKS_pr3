...
import 'add_car_page.dart'; // Импорт экрана добавления товара
...
class _CarListPageState extends State<CarListPage> {
  List<Car> cars = [
    Car(
        ...
        shortDescription: '4 650 000 ₽', // Исправлено
    ...
    Car(
        ...
        shortDescription: '21 498 000 ₽', // Исправлено
        ...
        return AlertDialog(
          ...
          actions: [
            ...
            TextButton(
              onPressed: () {
                setState(() {
                  cars.removeAt(index); // Удаление машины из списка
                });
                Navigator.of(context).pop(); // Закрытие диалога
              },
              child: Text('Delete'),
        ...
        itemBuilder: (context, index) {
          return Card(
            child: ListTile(
              ...
              subtitle: Text(cars[index].shortDescription), // Исправлено
              trailing: IconButton(
                icon: Icon(Icons.delete, color: Colors.red),
                onPressed: () => _deleteCar(index), // Удаление с подтверждением
              ),
              onTap: () {
                Navigator.push(
                  context,
          ...
          Navigator.push(
            ...
            MaterialPageRoute(
              builder: (context) => AddCarPage(
                onAddCar: (car) {
                  setState(() {
                    cars.add(car); // Добавление нового товара
                  });
                },
              ),
            ),
